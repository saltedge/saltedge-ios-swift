...
The current version of the SDK is [3.1.3](https://github.com/saltedge/saltedge-ios-swift/releases/tag/3.1.3), and supports the latest available version of Salt Edge API. Any backward-incompatible changes in the API will result in changes to the SDK.
